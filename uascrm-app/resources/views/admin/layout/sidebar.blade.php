...
<head>
    ...
    <title>Glamour Glow - Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Glamour Glow </div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{url('/admin/user/index')}}">User</a>
                        <a class="collapse-item" href="{{url('/admin/pelanggan/index')}}">Pelanggan</a>
                        <a class="collapse-item" href="{{ url('/admin/penyedia/index') }}">Penyedia</a>
                        <a class="collapse-item" href="{{ url('/admin/layanan/index') }}">Layanan</a>
                        <a class="collapse-item" href="{{ url('/admin/pemesanan/index') }}">Pemesanan</a>
                        <a class="collapse-item" href="{{ url('/admin/diskon/index') }}">Diskon</a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilit"
                    aria-expanded="true" aria-controls="collapseUtilities">
                    <i class="fas fa-fw fa-wrench"></i>
                    <span>Aktivis Perpustakaan</span>
                </a>
